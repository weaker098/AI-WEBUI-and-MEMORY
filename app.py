    ...
    try:
        ...
        if use_global_memory:
            ...
            if not _do_global_search():
                # Index missing or stale — rebuild synchronously then retry once.
                # rebuild_global_index() blocks until done, so the retry hits the
                # freshly written index instead of the empty/stale one.
