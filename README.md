...
## Be wary of each ctx settings as it might affect the recalls Quality! if you and your assistants messages average at 1-2k tokens per exchange then set to atleast 1500 tokens ctx on the embeddings! (if supported by the model.)
